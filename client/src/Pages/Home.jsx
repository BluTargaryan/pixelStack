    ...
    <>
      ...
      <section className='tw-bg-amber-400'>
        <div className='container tw-py-32'>
          <h1 className='tw-text-[3.5rem] sm:tw-text-[6.5rem] tw-font-semibold'>
            Stay curious.
          </h1>
          <p className='mt-4 tw-font-sans tw-tracking-tighter tw-font-medium tw-text-xl sm:tw-text-2xl'>
            Discover stories, thinking, and expertise from writers on any topic.
          </p>
          <button className='btn btn-dark tw-rounded-full tw-px-12 tw-py-2 mt-4 tw-text-xl tw-font-sans tw-tracking-tighter'>
            Start Reading
          </button>
        </div>
      </section>
